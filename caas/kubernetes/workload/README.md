...
| <a name="input_replica_group_by"></a> [replica\_group\_by](#input\_replica\_group\_by) | Select group by element on monitors | `list` | <pre>[<br>  "kube_namespace",<br>  "kube_replicaset",<br>  "kube_cluster_name"<br>]</pre> | no |
